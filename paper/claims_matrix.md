...
| Analytic asymptotic bracketing improves layer-compressed unranking | Implemented as non-proof search seed; clean updated artifact pending | Compare updated `results/benchmarks/full_xplusy_suite_1e12/` against prior artifact; report calls, rank gap, and wall time without overstating |
