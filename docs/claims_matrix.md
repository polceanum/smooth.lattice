...
| Implemented portfolio scoreboard | Clean portfolio artifact: 14/14 solver-agreement rows, 12/14 interval-certified rows, and 2/14 high-rank k=3 rows blocked only by auditor overflow | Artifact: `results/benchmarks/certified_portfolio_suite_1e9_1e12/`; use this as the current fastest-implemented scoreboard, not broad best-known language |
